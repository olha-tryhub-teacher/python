...
class AuthWindow(CTk):
    def __init__(self):
        ...
        self.ip_entry.pack(fil="x", padx=10, pady=10)
        self.port_entry = CTkEntry(self.right_frame, placeholder_text="Порт сервера")
        self.port_entry.pack(fil="x", padx=10, pady=10)
        self.client_button=CTkButton(self.right_frame, text="УВІЙТИ",command=self.open_message)
        self.client_button.pack(fill="x", padx=10, pady=5)
